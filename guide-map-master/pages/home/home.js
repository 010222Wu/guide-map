...
Page({
  ...
  data: {
    ...
    //用于打开关于我们界面
    isAboutShown: false,
    iconname: ['newspaper-o', 'filter-o', 'chart-trending-o', 'search', 'warn-o', 'search', 'user-circle-o', 'arrow', 'search', 'delete', 'search'],
    randomindex:0
  },
  ...
  onLoad: function (options) {
    ...
    this.setData({
      ...
      list: listData.init,
      listItem: listData[index][0].content,//存放地点列表信息，我把图片地址加在这里了，叫imgpath
